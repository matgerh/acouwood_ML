...
rel[a] = abs(c11[y].subtract(d14[y]))
rel[b] = abs(c41[y].subtract(d44[y]))
rel[c] = abs(c12[y].subtract(d15[y]))
rel[d] = abs(c42[y].subtract(d45[y]))
rel[e] = abs(c13[y].subtract(d16[y]))
rel[f] = abs(c43[y].subtract(d46[y]))

rel[g] = abs(c14[y].subtract(d14[y]))
rel[h] = abs(c44[y].subtract(d44[y]))
rel[i] = abs(c15[y].subtract(d15[y]))
rel[j] = abs(c16[y].subtract(d45[y]))
