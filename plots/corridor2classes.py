...
d7 = pd.read_csv('../data/1_4_e.txt', delimiter="\t")
d8 = pd.read_csv('../data/4_4_e.txt', delimiter="\t")
d9 = pd.read_csv('../data/1_5_e.txt', delimiter="\t")
d10 = pd.read_csv('../data/4_5_e.txt', delimiter="\t")
d11 = pd.read_csv('../data/1_6_e.txt', delimiter="\t")
d12 = pd.read_csv('../data/4_6_e.txt', delimiter="\t")
...
# d7.plot(x, y, ax=axes, color=decay, label="")
# d8.plot(x, y, ax=axes, color=decay, label="")
# d9.plot(x, y, ax=axes, color=decay, label="")
# d10.plot(x, y, ax=axes, color=decay, label="")
# d11.plot(x, y, ax=axes, color=decay, label="")
# d12.plot(x, y, ax=axes, color=decay, label="")
...
#plt.savefig('plot_corridor.pdf', format = 'pdf', dpi=400)
plt.show()
...
# html = 'Plot' + '<img src=\'data:image/png;base64,{}\'>'.format(encoded) + 'corridor'
