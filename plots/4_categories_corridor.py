...
n3 = pd.read_csv('../fft_data/1_4_d.txt', delimiter="\t")
n4 = pd.read_csv('../fft_data/4_4_d.txt', delimiter="\t")
n5 = pd.read_csv('../fft_data/1_5_e.txt', delimiter="\t")
n6 = pd.read_csv('../fft_data/4_5_e.txt', delimiter="\t")
n7 = pd.read_csv('../fft_data/1_8_m.txt', delimiter="\t")
n8 = pd.read_csv('../fft_data/4_8_m.txt', delimiter="\t")
...
axes.set_title(
    "Four categories - with between curves indicates the difference between 2 mountings for same sample."
)
axes.set_xlabel(x)
axes.set_ylabel(y)
#axes.set_xscale('log')
