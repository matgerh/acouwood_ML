...
#Read in files
n11 = pd.read_csv('../data/1_4_e.txt', delimiter="\t")
n21 = pd.read_csv('../data/2_4_e.txt', delimiter="\t")
n31 = pd.read_csv('../data/3_4_e.txt', delimiter="\t")
n41 = pd.read_csv('../data/4_4_e.txt', delimiter="\t")
n51 = pd.read_csv('../data/5_4_e.txt', delimiter="\t")
n61 = pd.read_csv('../data/6_4_e.txt', delimiter="\t")
...
axes.set_title("sample 4 - extreme moisture")
axes.set_xlabel(x)
axes.set_ylabel(y)
#axes.set_xscale('log')
