...
#Read in files
n11 = pd.read_csv('../data/1_2_n.txt', delimiter="\t")
n21 = pd.read_csv('../data/2_2_n.txt', delimiter="\t")
n31 = pd.read_csv('../data/3_2_n.txt', delimiter="\t")
n41 = pd.read_csv('../data/4_2_n.txt', delimiter="\t")
n51 = pd.read_csv('../data/5_2_n.txt', delimiter="\t")
n61 = pd.read_csv('../data/6_2_n.txt', delimiter="\t")
...
axes.set_title("sample 2 - normal")
axes.set_xlabel(x)
axes.set_ylabel(y)
#axes.set_xscale('log')
